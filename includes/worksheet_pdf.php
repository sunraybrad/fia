 ...
 *
 * Generates from scratchthe FIA In-Shop Worksheet (2-page letter PDF) using TCPDF.
 * No template files are used; all layout is built programmatically.
 *
 * Public API:
...
// ---------------------------------------------------------------------------
// Internal: build the TCPDF document and return raw bytes
// ---------------------------------------------------------------------------
...
function worksheet_pdf_bytes(int $fia, mysqli $db): string|false
{
    ...
    if (!$data) return false;
        // OLD: return _worksheet_build($data); builds PDF from scratch using TCPDF, with custom layout code in this file
